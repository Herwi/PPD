...
--Przedstawić trzy wersje, odpowiadające trzem różnym sposobom przeglądania elementów
--drzewa (bez wykorzystywania funkcji preoreder, postorder)
--preorder
...
tree_member3 (Node a l r) x | tree_member3 l x == True = True
                            ...
                            | otherwise = False
--zad 4
--Zdefiniować funkcję subtree, która sprawdza dla danych dwóch drzew, czy jedno jest
--poddrzewem drugiego. 
