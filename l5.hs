...
--zad 3
--Napisać funkcję, której wartością jest długość a) najdłuższej, b) najkrótszej gałęzi w drzewie
binarnym.
...
--zad 4
--Napisać funkcję, której wartością jest True, gdy drzewo binarne t ma w węzłach liczby
--całkowite i jest uporządkowane, tzn. elementy w lewym poddrzewie są mniejsze od korzenia,
--a w prawym poddrzewie – większe.
...
--zad 5
--Napisać program do przekształcania dowolnego drzewa binarnego do postaci drzewa
--uporządkowanego.
...
--zad 6
--Zdefiniować klasę typów Adres, a następnie typ Email będący instancją tej klasy. Zdefiniować
--dowolną funkcję wykorzystującą nowy typ. W komentarzu opisać działanie funkcji.
class Adres a where
